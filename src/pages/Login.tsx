...
const Login = () => {
  const handleSignIn = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // Bu kısımda kullanıcılar kendi auth logic'lerini implement edebilirler
    // Örnek: API call, Supabase auth, Firebase auth, etc.
  ...
  const handleResetPassword = () => {
    // Bu kısımda kullanıcılar password reset logic'lerini implement edebilirler
